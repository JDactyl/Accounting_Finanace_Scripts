...
Before running the script, update the following variables in reconcile.py to match your local environment:
    ...
    search_dir: The path to the folder where you store your PDF receipts. (script is operating-system agnostic)

    csv_input_path: The path to your bank or credit card CSV statement.
...
How It Works
    ...
    Reporting: The script writes results to a new CSV, detailing which PDF file matched which transaction.
